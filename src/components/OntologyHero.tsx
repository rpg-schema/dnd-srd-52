...
const OntologyHero = ({ title, description }: OntologyHeroProps) => {
  return (
    <header className="min-h-[70vh] flex flex-col items-center justify-center text-center px-6 py-20">
      ...
      <h1 className="text-5xl md:text-7xl font-bold text-gold mb-8 leading-tight">D&D SRD 5.5</h1>
      <p className="text-lg md:text-xl italic text-parchment max-w-2xl leading-relaxed">"{description}"</p>
